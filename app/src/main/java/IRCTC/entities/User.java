...
public class User {
    ...
    public String hashPasssord() {return this.hashPasssord;}
    public List<Ticket> ticketBooked() {return this.ticketBooked;}
    public String userId() {return this.userId;}

    public void setName(String newName) {this.name = newName;}
    public void setPassword(String newPassword) {this.password = newPassword;}
    public void setHashPasssord(String newSetHashPassword) {this.hashPasssord = newSetHashPassword;}
    public void setTicketBooked(List<Ticket> newTicketBooked) {this.ticketBooked = newTicketBooked;}
